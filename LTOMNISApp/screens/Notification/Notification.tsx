...
export type  NotificationTypes = EarnedPointsNotificationProps | SomeonePostedNotificationProps | PaymentDueNotificationProps | GroupInvitationNotificationProps | FriendRequestNotificationProps
            ...
            return (
                <View style={styles.Container}>
                    <View style={styles.RoleLabelContainer}>
                        ...
                        <View style={styles.info}>
                            <View>
                                <Text style={styles.bigText}>{`Someone posted in '${props.from}'`}</Text>
                            </View>
