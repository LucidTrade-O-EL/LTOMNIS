...
import Notification, { NotificationType, NotificationTypes } from './Notification';
...
export default function NotificationScreen() {
    ...
    const notifications: NotificationTypes[] = [
        ...
        { id: '3', type: NotificationType.PaymentDue, amount: 800, dateDue: '05/14/24' },
        ...
        { id: '8', type: NotificationType.PaymentDue, amount: 800, dateDue: '09/24/24' },
    ...
    return (
        <SafeAreaView style={styles.Background}>
            <ScreenTitle
                title="Notifications"
                showBackArrow={true}
                onBackPress={() => {// Handle the back button press, e.g., navigate back
                }}
            />
            <View>
                <FlatList
